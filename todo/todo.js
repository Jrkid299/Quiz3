...
var $author$project$Todo$initialModel = {details: '', loggedIn: false, status: false, task: ''};
...
var $author$project$Todo$SaveStatus = {$: 'SaveStatus'};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$type_('status'),
										$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Todo$SaveStatus)
									]),
								_List_Nil)
							])),
						A2(
